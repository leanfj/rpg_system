# Playing the Game - D&D Beyond Basic Rules - Dungeons & Dragons - Sources - D&D Beyond 
Playing the Game
----------------
...
**Make a Character.** Your character is your alter ego in the fantasy world of the game. After you read this chapter, use the rules in “Creating a Character” to create your character.
...
An adventure might be created by the Dungeon Master or purchased. In either case, an adventure features a fantastic setting, such as an underground dungeon, a wondrous wilderness, or a magic-filled city. It includes a cast of nonplayer characters controlled by the DM. Often one of the NPCs is a villain whose agenda drives much of an adventure’s action.
...
As with adventures, a DM might create a campaign from scratch, assemble a campaign from published adventures, or mix homemade material with published material. And the campaign might take place in a world of the DM’s creation or in a published campaign setting.
...
* Score: 1
  * Meaning: This is the lowest a score can normally go. If an effect reduces a score to 0, that effect explains what happens.
* Score: 2–9
  * Meaning: This represents a weak capability.
* Score: 10–11
  * Meaning: This represents the human average.
* Score: 12–19
  * Meaning: This represents a strong capability.
* Score: 20
  * Meaning: This is the highest an adventurer’s score can go unless a feature says otherwise.
* Score: 21–29
  * Meaning: This represents an extraordinary capability.
* Score: 30
  * Meaning: This is the highest a score can go.
...
* Ability: Strength
  * Attack Type: Melee attack with a weapon or an Unarmed Strike (see the Rules Glossary)
* Ability: Dexterity
  * Attack Type: Ranged attack with a weapon
* Ability: Varies
  * Attack Type: Spell attack (the ability used is determined by the spellcaster’s spellcasting feature, as explained in chapter 7)
...
* Skill: Acrobatics
  * Ability: Dexterity
  * Example Uses: Stay on your feet in a tricky situation, or perform an acrobatic stunt.
* Skill: Animal Handling
  * Ability: Wisdom
  * Example Uses: Calm or train an animal, or get an animal to behave in a certain way.
* Skill: Arcana
  * Ability: Intelligence
  * Example Uses: Recall lore about spells, magic items, and the planes of existence.
* Skill: Athletics
  * Ability: Strength
  * Example Uses: Jump farther than normal, stay afloat in rough water, or break something.
* Skill: Deception
  * Ability: Charisma
  * Example Uses: Tell a convincing lie, or wear a disguise convincingly.
* Skill: History
  * Ability: Intelligence
  * Example Uses: Recall lore about historical events, people, nations, and cultures.
* Skill: Insight
  * Ability: Wisdom
  * Example Uses: Discern a person’s mood and intentions.
* Skill: Intimidation
  * Ability: Charisma
  * Example Uses: Awe or threaten someone into doing what you want.
* Skill: Investigation
  * Ability: Intelligence
  * Example Uses: Find obscure information in books, or deduce how something works.
* Skill: Medicine
  * Ability: Wisdom
  * Example Uses: Diagnose an illness, or determine what killed the recently slain.
* Skill: Nature
  * Ability: Intelligence
  * Example Uses: Recall lore about terrain, plants, animals, and weather.
* Skill: Perception
  * Ability: Wisdom
  * Example Uses: Using a combination of senses, notice something that’s easy to miss.
* Skill: Performance
  * Ability: Charisma
  * Example Uses: Act, tell a story, perform music, or dance.
\page
* Skill: Persuasion
  * Ability: Charisma
  * Example Uses: Honestly and graciously convince someone of something.
* Skill: Religion
  * Ability: Intelligence
  * Example Uses: Recall lore about gods, religious rituals, and holy symbols.
* Skill: Sleight of Hand
  * Ability: Dexterity
  * Example Uses: Pick a pocket, conceal a handheld object, or perform legerdemain.
* Skill: Stealth
  * Ability: Dexterity
  * Example Uses: Escape notice by moving quietly and hiding behind things.
* Skill: Survival
  * Ability: Wisdom
  * Example Uses: Follow tracks, forage, find a trail, or avoid natural hazards.
...
See “Equipment” for rules on many items that are useful on adventures. The items in the “Tools” and “Adventuring Gear” sections are especially useful. The weapons in that chapter can also be used for more than battle; you could use a Quarterstaff, for example, to push a sinister-looking button that you’re reluctant to touch.
...
**_Dim Light._** Dim Light, also called shadows, creates a Lightly Obscured area. An area of Dim Light is usually a boundary between Bright Light and surrounding Darkness. The soft light of twilight and dawn also counts as Dim Light. A full moon might bathe the land in Dim Light.

**_Darkness._** Darkness creates a Heavily Obscured area. Characters face Darkness outdoors at night (even most moonlit nights), within the confines of an unlit dungeon, or in an area of magical Darkness.
...
**_Surprise._** If a combatant is surprised by combat starting, that combatant has Disadvantage on their Initiative roll. For example, if an ambusher starts combat while hidden from a foe who is unaware that combat is starting, that foe is surprised.
...
* Degree: Half
  * Benefit to Target: +2 bonus to AC and Dexterity saving throws
  * Offered By...: Another creature or an object that covers at least half of the target
* Degree: Three-Quarters
  * Benefit to Target: +5 bonus to AC and Dexterity saving throws
  * Offered By...: An object that covers at least three-quarters of the target
* Degree: Total
  * Benefit to Target: Can’t be targeted directly
  * Offered By...: An object that covers the whole target
...
\page
For example, if you have Resistance to Cold damage, such damage is halved against you, and if you have Vulnerability to Fire damage, such damage is doubled against you.
